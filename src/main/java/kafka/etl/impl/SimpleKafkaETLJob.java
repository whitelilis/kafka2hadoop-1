...
public class SimpleKafkaETLJob {
  ...
  protected JobConf createJobConf() throws Exception {
    JobConf jobConf = KafkaETLJob.createJobConf("Kafka Parallel Consumer: " + _topic, _topic, _props, getClass());

//    jobConf.setMapperClass(RawFileKafkaETLMapper.class);
    jobConf.setMapperClass(SimpleKafkaETLMapper.class);
    FileInputFormat.setInputPaths(jobConf, new Path(_input));
